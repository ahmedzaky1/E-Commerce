  ...
  <div class="drawer">
    ...
    >
      <v-card class="px-0" elevation="0">
        ...
        >
        <v-card-text class="px-0" style="color: rgb(135, 134, 134)"
          >{{ cartItems.length }} Item</v-card-text
        >
        <v-card-text
          class="px-0"
          style="color: rgb(135, 134, 134)"
          v-if="!cartItems.length"
          >Free Shopping for all orders over $10000.00</v-card-text
        >
        <v-card-text
        ...
        <v-card-text
          ...
          >Only<span style="color: red; font-weight: bold">
            {{ 10000 - calcTotalPrice }}
          </span>
        ...
        <v-container class="px-1">
          ...
          >
            ...
            <v-col cols="12" sm="7">
              ...
              >
              <v-card-text class="px-0 pb-0" style="color: rgb(135, 134, 134)">
                Category: {{ item.category }}
              </v-card-text>
              <v-card-text class="px-0 pt-2" style="font-weight: bold">
                ${{
                  Math.ceil(
              ...
              >
                ...
                >
                  <v-icon
                    size="19"
                    @click="item.quantity > 1 ? item.quantity-- : 1"
                    >mdi-minus</v-icon
                  >
                  <input
                    type="number"
      ...
      <v-card class="pa-0 mt-5" elevation="0" v-if="cartItems.length">
        <v-card-actions
          class="flex-column justify-center-align"
          style="gap: 15px"
        >
          <v-btn
            style="
