        ...
        >
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              ...
              :color="isHovering ? 'blue-lighten-2' : 'white'"
...
export default {
  data: () => ({
    cards: [
      ...
      {
        title: "Fast Shipping",
        des: "Fast and convenient door to door delivery",
      ...
      },
      {
        ...
        des: "More Than IO different secure payment methods",
      ...
      },
      {
        ...
        des: "24/7 customer service - we are here and happy to help ",
