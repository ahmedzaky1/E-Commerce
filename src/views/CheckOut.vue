      ...
      <v-row>
        <v-col cols="12" md="6" lg="7" class="order-1 order-md-0">
          ...
          >
            ...
            <v-card-actios
              class="d-flex justify-space-between align-center mb-7"
              style="gap: 10px"
            >
              <v-btn
                color="#6200ff"
            ...
            <v-card-title
              style="
                ...
                color: #484848;
              "
              >Shipping Addressess</v-card-title
            >
            <select
              name=""
              id=""
              class="w-100 px-3 pa-3"
              ...
              "
            >
              <option value="" v-for="country in counties" :key="country">
                {{ country }}
              </option>
            </select>
            <div class="user-name d-flex align-center" style="gap: 15px">
              <input
                type="text"
                class="pa-3 mt-4"
                style="
            ...
            />
            <div class="city-parent d-flex align-center" style="gap: 15px">
              <input
                type="text"
                class="pa-3 mt-4"
                style="
            ...
            <v-divider
              ...
              color="success"
            ></v-divider>
            <v-card-text style="font-size: 10px; color: #77777"
              >All Rights Reserved Ahmed Zaky</v-card-text
            >
          </v-card>
        </v-col>
        <v-col cols="12" md="6" lg="5">
          ...
          >
            ...
            >
              ...
              <v-card-text
                class="flex-grow-0"
                style="font-size: 12px; color: #484848"
              >
                ${{
                  Math.ceil(
...
export default {
  ...
  data: () => ({
    counties: ["Egypt", "Lebnan", "America", "Seria"],
    dialog: false,
  }),
  computed: {
